...
using FICS.App.Source.GameSubsystem.Exceptions;
using FICS.App.Source.GameSubsystem.Modes.Auth;
using FICS.App.Source.GameSubsystem.Modes.Game;
using FICS.App.Source.GameSubsystem.Modes.Seek;
using FICS.App.Source.LogSubsystem;

namespace FICS.App.Source.GameSubsystem
{
    /// <summary>
