...
using FICS.App.Source.GameSubsystem.Modes.Game.Exceptions;
using FICS.App.Source.GameSubsystem.Modes.Game.Style12;
using FICS.App.Source.LogSubsystem;

namespace FICS.App.Source.GameSubsystem.Modes.Game
{
    /// <summary>
