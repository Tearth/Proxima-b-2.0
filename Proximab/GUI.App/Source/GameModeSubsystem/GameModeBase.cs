...
namespace GUI.App.Source.GameModeSubsystem
{
    internal abstract class GameModeBase
    {
        ...
        void DisplayEvaluation(Command command)
        {
            ...
            _consoleManager.WriteLine($"$cPawn str:\t$w{evaluation.PawnStructureResult.WhiteDoubledPawns}\t{evaluation.PawnStructureResult.BlackDoubledPawns}");
            _consoleManager.WriteLine($"$cPawn iso:\t$w{evaluation.PawnStructureResult.WhiteIsolatedPawns}\t{evaluation.PawnStructureResult.BlackIsolatedPawns}");
