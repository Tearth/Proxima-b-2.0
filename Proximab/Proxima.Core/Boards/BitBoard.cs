...
namespace Proxima.Core.Boards
{
    ...
    public class Bitboard
    {
        ...
        /// <summary>
        /// Gets the last moves history.
        /// </summary>
        public ulong[] History { get; set; }

        /// <summary>
        /// Gets the reversible moves count (moves that can be reversed by legal moves sequence).
        /// </summary>
        ...
        /// <summary>
        /// Cleans data generated by <see cref="Calculate(bool)"/> method.
        /// </summary>
        ...
        /// <summary>
        /// Checks if there is a threefold repetition based on last moves history.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets the bitboard hash for the specified color.
        /// </summary>
        /// <param name="color">The color.</param>
        /// <returns>The bitboard hash for the specified color.</returns>
